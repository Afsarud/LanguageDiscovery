    ...
    public partial class Talk : System.Web.UI.Page
    {
        ...
        private int CreatePalleteList(bool own)
        {
            ...
            foreach (PaletteContract paleteContract in list)
            {
                ...
                divForeign.Attributes.Add("style", commoncss + "width: 30%; height: auto;");
                ...
                divNativ.Attributes.Add("style", commoncss + "width: 20%; height: auto;");
                divEachPalette.Controls.AddAt(indx, divNativ);

                indx += 1;
                HtmlGenericControl divNativSub = new HtmlGenericControl("div");
                divNativSub.Attributes.Add("id", "divNativSub");
                divNativSub.Attributes.Add("style", commoncss + "width: 20%; height: auto;");

    ...
    public partial class Talk : System.Web.UI.Page
    {
        ...
        private int CreatePalleteList(bool own)
        {
            ...
            foreach (PaletteContract paleteContract in list)
            {
                ...
                divEdit.Attributes.Add("style", commoncss + "width: 40%; height: auto; display: none !important;");
                ...
                divEmailIcon.Attributes.Add("style", commoncss + "width: 5%; height: auto; margin-top:0px");

...
<![endif]-->
    <script type="text/javascript">
        ...
        //function editButtonOnClickQQ(element, cEleId) {
        //    ////var cid = cDivId;
        //    //var clonedUL = $(element).parent().clone();

        //    ////element.css = element.id;

        //    //var newEleId = cEleId + 'N';
        //    ////clonedUL.id = newEleId;
        //    //clonedUL.attr("id", newEleId);
        //    //$("#destinationDiv").append(clonedUL);

        //    //alert(clonedUL.name);

        //    ////$(cls).css("display", "inline-block");
        //    //var newEl = document.getElementById(clonedUL.id);
        ...
        //    var ELE = document.getElementById(cEleId);
        //    var newELE = $(ELE).parent().clone();
        //    $("#destinationDiv").append(newELE);
        //    var newEleId = cEleId + 'N';
        //    newELE.id = newEleId;
        //    //newELE.attr("id", newEleId);


        //    //alert(newELE.id);

        //    var newELE2 = document.getElementById(newEleId);
        //    if (newELE2.style.display !== "none") {
        //        newELE2.style.display = "none";
        //    } else {
        //        newELE2.style.display = "block";
        //    }


        ////}
       
        //function editButtonOnClick(element, cDivId) {
        ...
        //        $('#mtabs').tabs("option", "active", 0);
        //    //return false;
        //    var ulelement = $(element).parent().clone();
        //    //element.css = element.;

        //    $("#sbc_right_container").append(ulelement);
        //    //document.getElementById('sbc_right_container').style.display = "block";

        //    const newDiv = document.createElement("div");
        //    newDiv.setAttribute("id", "Div1");
        //    var div = document.getElementById(cDivId);
        //    $("#newDiv").append(div);
        //    $("#sbc_right_container").appendTo('#newDiv');
        //    $("#sbc_right_container").append(div);
        //    /*
        //    if (div.style.display !== "none") {
        //        div.style.display = "none";
        //    }
    ...
    <div id="destinationDiv" style="background: silver; width: 100%; height: auto;"></div>
    <div id="divDeviceList" style="display: none; z-index: 1000000000;">
        <ul style="list-style: none;">
            <li>
                <asp:Label ID="lblCamera" runat="server" Style="font-weight: bold;" Text="Select Camera" ClientIDMode="Static" meta:resourcekey="lblCameraResource1"></asp:Label></li>
            <li>
            ...
            <li>
                <asp:Label ID="lblMicrophone" runat="server" Style="margin-top: 10px; display: inline-block; font-weight: bold;" Text="Select Microphone" ClientIDMode="Static" meta:resourcekey="lblMicrophoneResource1"></asp:Label></li>
            <li>
            ...
            <li>
                <asp:Label ID="lblSpeakers" runat="server" Style="margin-top: 10px; display: inline-block; font-weight: bold;" Text="Select Speaker" ClientIDMode="Static" meta:resourcekey="lblSpeakersResource1"></asp:Label></li>
            <li>
    ...
    <div style="width: 100%;">
        ...
        <div id="emojigallery" style="width: 800px; display: none;">
            <div id="tabs" style="height: 90%;">
                <ul style="display: none;">
                    <li>
                        <asp:HyperLink ID="HyperLink1" href="#emoji" runat="server" Text="Emoji" meta:resourcekey="HyperLink1Resource1" Style="display: none;" /></li>
                    <li>
                        <asp:HyperLink ID="HyperLink2" href="#sticker" runat="server" Text="Sticker" Style="display: none;" meta:resourcekey="HyperLink2Resource1" /></li>
                    <li>
                        <asp:HyperLink ID="HyperLink3" href="#punctuation" runat="server" Text="Punctuation" meta:resourcekey="HyperLink3Resource1" Style="display: none;" /></li>
                </ul>
        ...
        <div id="top_container">
            <div id="divTalkScheduleContainer">
                ...
                <div class="take_recruit_support_container">
            ...
            <div class="sendmsg_top_container" id="sendmsg_top_container">
             ...
             <%--   <div id="renderer01_timesSection" class="sessionContainer" style="display: none; margin-left: 10px">
                ...
                <%--tipu's code--%>
                 <div id="renderer01_timesSection" class="sessionContainer" style="display: none; margin-left: 10px; height:30px; background-color: white; justify-content: center; align-items: center; cursor:pointer; margin-right: 0px;">
                                 <img src="../Images/callEnd.png" onclick="endCameraTesting();" style="width: 54px;"/>
                     <%--<p onclick="endCameraTesting()>Leave Call</p>--%>
                          </div>
                <%--<div   style="display:none;">
                        <img src="../Images/new/custom_video.png" id="btnCallIcon" class="btnCallIconDisabled"  onclick="CreateAndJoinConference(event);" style="border: 1px solid red;"/>
                    </div>--%>

                <%--   <div id="renderer01_bottomSection" style="display:none; background-color: red" >
        ...
        <div class="sendmsg_middle_container" id="sendmsg_middle_container">
            <div id="mtabs">
                <div class="smc_criteria_container" id="smc_criteria_container">
                        ...
                        <div style="float: left;" class="smc_search_child_container">
                            <div class="divSearchContainer">
                                ...
                                <div id="divSearchLowerRow" class="divSearchRow">
                                    <div id="lblTopicsLabelContainer" style="display: none;">
                                        <asp:Label ID="lblTopicsLabel" CssClass="" runat="server" Text="Topics:" meta:resourcekey="lblTopicsLabelResource1"></asp:Label>
                                    </div>
                            ...
                            <ul class="tabs_links_menu">
                                <li class="prhraseTabs">
                                    <asp:HyperLink CssClass="send-msg-tabs1" ID="linkTabPhrases" href="#mtab1" runat="server" Text="Phrases" meta:resourcekey="linkTabPhrasesResource1" /></li>
                                <li class="prhraseTabs tabAddToMyPhrases">
                                    <asp:HyperLink CssClass="send-msg-tabs2" ID="linkMyPhrases" href="#mtab2" runat="server" Text="Own Palette" meta:resourcekey="linkMyPhrasesResource1" /></li>
                                <li style="display: none;">
                                    <asp:HyperLink CssClass="send-msg-tabs3" ID="linkTabOptions" href="#mtab3" runat="server" Text="Options" meta:resourcekey="linkTabOptionsResource1" /></li>
                                <li id="liTabWordForPhrase" class="wordTab" style="background: #3868D6 !important;">
                                    <asp:HyperLink CssClass="send-msg-tabs5" ID="HyperLink4" href="#mtab5" runat="server" Text="Word" meta:resourcekey="linkTabWordResource1" /></li>
                                <li id="liTabUserWordForPhrase" class="wordTab">
                                    <asp:HyperLink CssClass="send-msg-tabs6" ID="HyperLink5" href="#mtab6" runat="server" Text="My Word" meta:resourcekey="linkTabUserWordResource1" /></li>
                            </ul>
                            ...
                            <div class="divAddOwnPaletteContainer" >
                                ...
                                <button style="margin-top: -70px" type="button" id="btnAddOwnPalette" class="btnUpdate_profile btnAddOwnPalette" onclick="saveOwnPalette();"></button>
                 ...
                 <%--new switch button position start from here ex- Native lang, Kanji...--%>
                <div id="mtab1">
                        ...
                        <div class="sbc_left_container">
                            ...
                            <asp:UpdatePanel ID="updOwnPalette" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <div class="sentencepagingContainer">
                                        <div id="sentencePagingOwnPalette" title="Page"></div>
                                    </div>
                ...
                <div id="mtab3">
                    <div class="sbc_right_container" id="sbc_right_container" >
                        ...
                        <div class="src_frame" >
                            ...
                            <div class="switch_container" id="divRomanji" runat="server" style="display: none;">
                                <div class="sc_lbl">
                ...
                <div class="smc_word_container" id="smc_word_container">
                    <div id="wordTabsContainer" style="display: none;">
                        <div id="wordtabs">
                            <ul>
                                <li id="liTabWord" class="wordTab">
                                    <asp:HyperLink CssClass="send-msg-tabs5" ID="linkTabWord" href="#mtab5" runat="server" Text="Word" meta:resourcekey="linkTabWordResource1" /></li>
                                <li id="liTabUserWord" class="wordTab">
                                    <asp:HyperLink CssClass="send-msg-tabs6" ID="linkTabUserWord" href="#mtab6" runat="server" Text="My Word" meta:resourcekey="linkTabUserWordResource1" /></li>
                            </ul>
                            ...
                            <div id="mtab5">
                                ...
                                <div id="divWordPaletteOtherContainer1">
                                    ...
                                    <div class="steptitlepagingContainer centerElementContainer" style="display: none;">
                                        ...
                                        <asp:Label ID="lblLabelWordPaging" runat="server" Text="Word palette" meta:resourcekey="lblLabelWordPagingResource1" Style="line-height: 24px; text-align: center; font-weight: bold; background-color: #3868D6 !important; color: white; border: 1px solid red;"></asp:Label>
                                    </div>
                                    <div class="steptitlepagingContainer">

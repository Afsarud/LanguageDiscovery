...
<![endif]-->
     <%--Start Added by afsar 02092024--%>
                          

    <%--end Added by Afsar 02092024--%>
    <script type="text/javascript">
        ...
        function checkLanguage() {
            language_er_jp = $('#hdnNativeLanguageCode').val();

        }
        console.log(language_er_jp);
        ...
        function InitializeChatHub() {
            ...
            function showCallAlert(receiver, from, room, group) {
                ...
                $toast.delegate('.clear', 'click', function () {
                    ...
                    // Stop the call on the sender's side
                    endCallFromSender();
                });

                // Answer Button Click Event

                // Answer Button Click Afsar start 
                $toast.delegate('.btnAnswer', 'click', function () {
                    toastr.clear();

                    // Mark call as answered and initialize the video session
                    if (!IsCallerSelected(from)) {
                        ...
                        $("#renderer0").show(); // Show sender's video window
                        // $("#renderer1").show(); // Uncomment if needed for receiver's video window
                        Ring(false); // Stop ringing on both sides
                        ...
                        startMeetingTimer(); // Start the timer when the call is answered

                        // Add the room and start the conference
                        AddConferenceRoom(room, from, $("#hdnCurrentUserName").val());
                    }
                });

                // Answer Button Click Afsar End
            ...
            function endCallFromSender() {
                debugger
                // Logic to stop the call from the sender's side
                // Ensure the video call session ends and UI elements are reset
                $('#btnCallIcon').removeClass("callStart");
                $("#renderer0").hide(); // Hide sender's video window
                $("#renderer1").hide(); // Hide receiver's video window if shown
                // Additional clean-up actions as needed
            }



            //Start Comment Afsar27082024
            //function showCallAlert(receiver, from, room, group) {
            //    toastr.options = {
            //        "closeButton": false,
            //        "debug": false,
            ...
            //End Comment Afsar27082024

           

            // Client-side event for when a user signs out
            ...
            // Client-side event for when a user logs out of the session
            chat.client.logoutSession = function (id) {
                var el = $(".divUsers[data-userid='" + id + "']");
                if (el) {
                    $(el).find("#imgOnTalkStatus").attr("src", "../images/new/offline.png");
                    $(el).attr("data-isonline", "false");
                    DisableEnableCallButton();
        ...
        $(function () {
            ...
            $('#renderer01_timesSection_cam_testing_new').click(function (e) {
                e.preventDefault();
                OpenDeviceList();
                return false;
            });
            $('#renderer02').click(function (e) {
                e.preventDefault();
                OpenDeviceList();
                return false;
            });
            $('#renderer01').click(function (e) {
                e.preventDefault();
                OpenDeviceList();
                return false;
            });
            
            $('#renderer0').click(function (e) {
                e.preventDefault();
                OpenDeviceList();

            });
            //Afsar15
            //$('#renderer1').click(function (e) {
            //    e.preventDefault();
            //    OpenDeviceList();
        ...
        function AppendCircleButton() {
            ...
            $(".pallete").each(function () {
                if ($(this).find("#addallWords").size() == 0)
                    $(this).append("<div style='position:relative;float:right'><img id='addallWords' class='addallwords' onclick='AddAllWords(this, event);'  src='../images/new/talkSendNew.png' style='width:32px;height:32px;padding-left:1px;padding-right:1px;cursor:pointer'/>" +
        ...
        $(function () {
            ...
            //----------------------------------
            //------
            //clicking save button => saving data into data base
            //------
        ...
        function prepareCallToolsButton() {
            if ($('#hdnNativeLanguageCode').val() == "en-US") {
                ...
                $('#kanjiButton').addClass("divShowHideKanjiButtonBasenOnUser");
                ...
                $('#divFreeMessageImage').addClass("square");
                $('#divIssueImage').addClass("divIssueImage_jp");
                $('#divIssueImage').addClass("square");
                $('#divAdviceImage').addClass("divAdviceImage_jp");
                $('#divAdviceImage').addClass("rectangle1");
            }
        }

        function LeaveCallButtonOnUser() {
            debugger;
            if ($('#hdnNativeLanguageCode').val() == "en-US") {
                $('#divCallEndBtn_en_version').addClass("divCallEndBtn_en");
                $('#divCallEndBtn_en_version1').addClass("divCallEndBtn_en");

            }
            else {
                $('#divCallEndBtn_en_version').addClass("divCallEndBtn_jp");
                $('#divCallEndBtn_en_version1').addClass("divCallEndBtn_jp");
        ...
        function startRingingTimer() {
            setTimeout(function () {
                if (_SomeoneIscalling) {
                    ...
                    $("#renderer01_timesSection").hide();
                    var currentuser = $("#hdnCurrentUserName").val();
                    var room = currentuser.replace("@", "_") + $("#lblLastName").text().replace("@", "_");
                    if ($.connection.hub.state === $.signalR.connectionState.disconnected) {
                        $.connection.hub.start().done(function () {
                            chat.server.hangup(currentuser, $("#hdnGroupName").val(), room);
                        });
                    } else {
                        chat.server.hangup(currentuser, $("#hdnGroupName").val(), room);
                    }
        ...
        // start uncomment Afsar 01092024
        ...
        function TestCamera() {
            alert("Do you want to camera test!");
            _SomeoneIscalling = true;
            $("#renderer01").show();
            $("#renderer01_timesSection_cam_testing").show();
            //if (!detectWebcam()) {
            //    return false;
            //}
    ...
    <div id="divCallAlert" style="display:none;" >
        ...
        <br />
        <img src="../Images/new/CallingStatic.png" id="calling" style="display:block;margin:auto;width: 54px;"/>
    </div>
...
<%--        <asp:HiddenField ID="hdnParentsInfoFlag" runat="server" ClientIDMode="Static" />
      ...
      <%-- <div id="divParentsInfo" style="display:none;">
        ...
        <div id="top_container">
                ...
                <div id="divTalkScheduleContainer">
                      ...
                      <div id="divActionContainer">
                        <div id="divActionInnerContainer">
                            ...
                            <img class="actionButton" id="imgInstructionVideo" src="../Images/new/E_InstructionVideo_new.png" onclick="talkProcess();" /> 
             ...
             <div id="renderer1" style="display:none; position: relative;"></div> 
                <%--<div id="renderer1" style="display:none;width:35%;height: 210px;"></div> --%>
                 ...
                 <div class="sendmsg_top_container" id="sendmsg_top_container" >
                    ...
                    <button style="width: 100%; background-color: white; color: #444444; text-align: center; border: 1px solid #D9EEFC; border-radius: 8px; box-shadow: 0px 1px 6px 0px rgba(0, 0, 0, 0.15);">
                       ...
                       <div id="renderer01_timesSection_cam_testing" class="sessionContainer" style="z-index: 25">
                            <div id="renderer01_timesSection_cam_testing_new" style="margin-top: -18px; width: 100%; position: absolute;" >
                    <button style="width: 100% !important; background-color: white; color: #444444; text-align: center; border: 1px solid #D9EEFC; border-radius: 8px; box-shadow: 0px 1px 6px 0px rgba(0, 0, 0, 0.15);">
                        Audio Setting</button>
   
                </div>
                                <div class="renderer01_timesSection_cam_testing_img "  onclick="endCameraTesting();">
                                     <%--<img src="../Images/callend_new.png" style="height: 35px; width: 100px; object-fit: cover; gap: 10px"/>--%>
                                    <div id="divCallEndBtn_en_version">

                                    </div>
                                </div>
                           </div>
                     <%--Afsar18--%>
                      <div id="renderer01_timesSection" class="sessionContainer" style="display: none; justify-content:space-between !important; align-items:center !important;margin-top: 259px; z-index: 10; width: 50%; position: absolute; z-index: 1;">                               
                                <div id="divCallEndBtn_en_version1" style="display:flex; cursor:pointer; justify-content:flex-start; align-items:center"  onclick="CreateAndJoinConference(event);">
                                </div>
                ...
                <div id="callContainer">                  
                        ...
                        <div class="divRemainingTimeLabel">
                            ...
                            <div class="minContainer">
                                <div style="display:flex">
                                     <img src="../Images/new/Stopwatch.png" style="width: 25px; height: 25px; object-fit: cover"/>
                    ...
                    <asp:UpdatePanel ID="updateSelectedUser" runat="server" UpdateMode="Conditional">
                            ...
                            <div class="mailbox_chatroom_profile" id="mailbox_chatroom_profile">
                                <div id="divUser" runat="server">
                                    <div class="mcp_avatar" id="mcp_avatar" style="display:none;">
                                        ...
                                        <asp:Image ID="imgAvatar" CssClass="selected_mcp_avatar_img" runat="server" ClientIDMode="Static" meta:resourcekey="imgAvatarResource1"/>
                                    </div>
                     ...
                     <div id="renderer2" class="remoteView" style="display:none; position: relative;">
                        ...
                        <div id="meetingTimer" style="position: absolute; top: 10px; left: 10px; background-color: rgba(0, 0, 0, 0.5); color: white; padding: 5px 10px; border-radius: 5px; display: none;">
                ...
                <div id="divMessageContainer">
                    ...
                    <div id="divToolsContainer">
                        <div class="custom_div_1">
                            ...
                            <div id="divImReady" class="square" style="display:none">
                            ...
                            <%--<div class="divStepCircle" id="stepPresent"></div>--%>
                        </div>
                        <div id="divRepeatImage" class="square">
                           ...
                           <%-- <div class="divStepCircle" id="stepPleaseRepeat"></div>--%>
                        </div>
                        <div id="divTextMeImage" class="square">
                           ...
                           <%-- <div class="divStepCircle" id="stepTextMe"></div>--%>
                        </div>
                        <div id="divFreeMessageImage" class="square" runat="server" ClientIDMode="Static" onclick="FreeMessage(); return false;">
                           ...
                           <%-- <div class="divStepCircle" id="stepFreeMessage"></div>--%>
                        </div>
                        </div>
                        <div class="custom_div_2">
                            <div id="divIssueImage" class="square2">
                        </div>
            ...
            <div id="mtabs">
                <div class="smc_criteria_container" id="smc_criteria_container">
                    ...
                    <div style="float:left;" class="smc_search_child_container">
                        <div class="divSearchContainer">
                            ...
                            <div id="divSearchLowerRow" class="divSearchRow">
                                ...
                                <div class="smc_search_container_search_box_txt" id="word_search" style="display:none">
                    ...
                    <ul class="tabs_links_menu">
                        ...
                        <li class="prhraseTabs tabAddToMyPhrases" style="background: #8B8484 !important;"><asp:HyperLink CssClass="send-msg-tabs2" ID="linkMyPhrases" href="#mtab2" runat="server" Text="Own Palette" meta:resourcekey="linkMyPhrasesResource1"/></li>
						...
						<li id="liTabWordForPhrase" class="wordTab" style="background: #3868D6 !important; color: #FFFFFF !important; display: none"><asp:HyperLink CssClass="send-msg-tabs5" ID="HyperLink4" href="#mtab5" runat="server" Text="Word" meta:resourcekey="linkTabWordResource1"/></li>
						<li id="liTabUserWordForPhrase" class="wordTab"  style="background: #8B8484 !important; display: none"><asp:HyperLink CssClass="send-msg-tabs6" ID="HyperLink5" href="#mtab6" runat="server" Text="My Word" meta:resourcekey="linkTabUserWordResource1" /></li>
                    </ul>
                  ...
                  <div id="mtab1">
                    ...
                    <div class="src_frame">
                        <div class="switch_container" style="display: none;">
                            ...
                            <div class="sc_conf" style="display: none;">
                          ...
                          <div class="switch_container" id="kanjiButton">
                            <div class="sc_lbl">
                       ...
                       <%-- <div class="switch_container" >
                            <div class="sc_lbl">
                                <asp:Label ID="Label7" runat="server" Text="1st Language" meta:resourcekey="lblNativeResource1"></asp:Label>
                            </div>
                            <div class="sc_conf">
                                <div class="make-switch" data-on="warning" data-off="default">
                      ...
                      <%--  <div class="switch_container">
                            <div class="sc_lbl" >
                                <asp:Label ID="Label9" runat="server" Text="Shadowing" meta:resourcekey="lblSoundResource1"></asp:Label>
                            </div>
                            <div class="sc_conf">
                                <div class="make-switch" data-on="warning" data-off="default">

...
namespace Language.Discovery
{
    public partial class Talk : System.Web.UI.Page
    {
        ...
        private string cLanguage = string.Empty;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                cLanguage = Convert.ToString(SessionManager.Instance.UserProfile.NativeLanguage);
        ...
        private int CreatePalleteList(bool own)
        {
            ...
            foreach (PaletteContract paleteContract in list)
            {
                ...
                var pnativelist = paleteContract.PhraseList.FindAll(x => x.LanguageCode.Equals(SessionManager.Instance.UserProfile.NativeLanguage)).OrderBy(x => x.Ordinal).ToList();
                var plearninglist = paleteContract.PhraseList.FindAll(x => x.LanguageCode.Equals(SessionManager.Instance.UserProfile.LearningLanguage)).OrderBy(x => x.Ordinal).ToList();
                var psubnativelist = paleteContract.PhraseList.FindAll(x => x.LanguageCode.Equals(SessionManager.Instance.UserProfile.SubNativeLanguage)).OrderBy(x => x.Ordinal).ToList();
                var psubnative2list = paleteContract.PhraseList.FindAll(x => x.LanguageCode.Equals(SessionManager.Instance.UserProfile.SubNativeLanguage2)).OrderBy(x => x.Ordinal).ToList();
                ...
                HtmlGenericControl divNativSub = new HtmlGenericControl("div");
                indx += 1;
                divEdit.Attributes.Add("id", "divEdit");
                divEdit.Attributes.Add("style", commoncss + "width: auto; height: auto; display: none !important;");
                divEachPalette.Controls.AddAt(indx, divEdit);

                if (cLanguage == "ja-JP")
                {
                    indx += 1;
                    divForeign.Attributes.Add("id", "divForeign");      //English 
                    divForeign.Attributes.Add("style", commoncss + "width: 40%; height: auto;");
                    divEachPalette.Controls.AddAt(indx, divForeign);

                    indx += 1;
                    divNativ.Attributes.Add("id", "divNativ");      //Harigana
                    divNativ.Attributes.Add("style", commoncss + "width: 20%; height: auto; display: none !important;");
                    divEachPalette.Controls.AddAt(indx, divNativ);

                    indx += 1;
                    divNativSub.Attributes.Add("id", "divNativSub");      //Kanji
                    divNativSub.Attributes.Add("style", commoncss + "width: 40%; height: auto;");
                    divEachPalette.Controls.AddAt(indx, divNativSub);
                }
                else
                {
                    indx += 1;
                    divForeign.Attributes.Add("id", "divForeign");      //Harigana
                    divForeign.Attributes.Add("style", commoncss + "width: 40%; height: auto;");
                    divEachPalette.Controls.AddAt(indx, divForeign);

                    indx += 1;
                    divNativSub.Attributes.Add("id", "divNativSub");      //Kanji
                    divNativSub.Attributes.Add("style", commoncss + "width: 20%; height: auto; display: none !important;");
                    divEachPalette.Controls.AddAt(indx, divNativSub);

                    indx += 1;
                    divNativ.Attributes.Add("id", "divNativ");      //English
                ...
                if (soundfilelearning.Length > 0)
                    //parentli.Controls.AddAt(0, sound);
                    divSpeaker.Controls.AddAt(0, sound);

                else
                    //parentli.Controls.AddAt(0, divsoundcont);
                    divSpeaker.Controls.AddAt(0, divsoundcont);
                ...
                editButton.Attributes.Add("style", "width: 50px; height: 25px;");
                ...
                divEdit.Controls.AddAt(divEditIndex, editButton);
                ...
                foreach (var item in plearninglist)
                {
                    ...
                    //divForeign.Controls.AddAt(divForeignIndex, emtLabel);
                ...
                foreach (var item in pnativelist)
                {
                    ...
                    wrd.Text = item.Word + "&nbsp;";
                    //wrd.Text = item.Word;
                    wrd.ForeColor = System.Drawing.Color.Black;
                    //indx += 1;
                    //parentli.Controls.AddAt(indx, emtLabel);
                    divNativIndex += 1;
                    //parentli.Controls.AddAt(indx, wrd);
                ...
                int divNativSubIndex = -1;
                foreach (var item in psubnative2list)
                {
                    var wrd = new Label();
                    wrd.Text = item.Word + "&nbsp;";
                    //wrd.Text = item.Word;
                    ...
                    divNativSubIndex += 1;
                    //parentli.Controls.AddAt(indx, wrd);
                    divNativSub.Controls.AddAt(divNativSubIndex, wrd);
                }
                ...
                childul.Attributes.Add("data-sentence1Ordinal", sentence1ordinal);
                childul.Attributes.Add("data-sentence2Ordinal", sentence2ordinal);
                childul.Attributes.Add("style", "padding:0px; display: none !important");

    ...
    public partial class Talk : System.Web.UI.Page
    {
        ...
        private int CreatePalleteList(bool own)
        {
            ...
            foreach (PaletteContract paleteContract in list)
            {
                ...
                //editButton.Text = "<button class='editButtonClass' onClick='clickFunction()'> Edit<button/>";
                ...
                //editButton.Text = "<button class='editButtonClass' onClick='clickFunction_test(parentli)'> Edit<button/>";
                //editButton.Attributes.Add("css", "editButtonClass");
                ...
                editButton.Attributes.Add("style", "width: 150px;height: 15px;");
                editButton.Attributes.Add("data-paletteid", paleteContract.PaletteID.ToString());
                editButton.Attributes.Add("value", "Edit");
                editButton.Attributes.Add("onclick", "aaaa(this)");

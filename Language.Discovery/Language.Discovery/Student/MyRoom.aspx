...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server" enctype="multipart/form-data">
	...
	<script type="text/javascript">
        ...
        $(function () {
            ...
            $('.hotspot-container2').click(function () {
                showProfile();
   ...
   <%-- <div id="divMyRoomQuickGuide" style="display: none;">
	...
	<div class="profile_left_Container" id="profile_left_Container">
        ...
        <div class="prof_top_container" id="prof_top_container">
			<img id="imgStatusBox" src="../Images/new/statusNew.png" />
            ...
            <div id="divPhotoContainer" style="display: none">
        ...
        <div class="lblLikeCount" style="display:none">
			<div style="padding-left: 50px;float:left; display: none">
			...
			<div class="prof_left_top" id="prof_left_top">
				<div id="changemyroom">
                    <div id="divMyRoomButtonContainer">
                        <asp:Button ID="btnChangeAvatar" CssClass="buttons" style="background-image:url('../Images/new/Change_my_avatar.png'); background-color:Transparent; cursor:pointer; background-repeat:no-repeat; background-position:center; padding-left:15px; background-size: cover; border-radius:8px;"  Height="36px" BorderStyle="None" Width="194px"  runat="server" Text="" ClientIDMode="Static" />
					    <asp:Button ID="btnChangeMyRoom" CssClass="buttons" style="background-image:url('../Images/new/change_my_room.png'); background-color:Transparent; cursor:pointer; background-repeat:no-repeat; display: none; background-position:center; padding-left:15px;background-size: cover; border-radius:8px;" Height="36px" BorderStyle="None" Width="194px"  runat="server" Text=""  ClientIDMode="Static" />
					   <%-- <asp:Button ID="btnAboutMe" CssClass="buttons" style="background-image:url('../Images/new/aboutMe.png.png'); background-color:Transparent; cursor:pointer; background-repeat:no-repeat; background-position:center; padding-left:15px;background-size: cover; border-radius:8px;" Height="36px" BorderStyle="None" Width="194px"  runat="server" Text=""  ClientIDMode="Static" />--%>
                        <div>
                            <img class="hotspot-container2" id='aboutMe' src="../Images/new/aboutMe.png" style="border-style: None;
    height: 36px; width: 194px; background-color: Transparent; cursor: pointer; background-repeat: no-repeat; background-position: center; padding-left: 3px; background-size: cover; border-radius: 8px;"/>
                        </div>
                    </div>
	...
	<div class="profile_right_Container" id="profile_right_Container">
	    <div class="hotspot-container" style="display: none">
        ...
        <div id="divRightContainer" style="display: none">
            <div id="divClickBook">
            ...
            <div id="innerDivThemesContainer">
                <div id="zeroRow" class="rows">
                    <div class="divColorContainer">
                        <div id="japaneseRoom1" class="theme solidThemes" data-color="solid_japaneseRoom" style="background-image: url('../Images/skin/myroom/new_bg_image_adult_version.png'); background-position:center; background-size: contain;background-repeat: no-repeat;  top: 61px;" onclick="SelectColor(this);" >
                        ...
                        <div id="australiaRoom1" class="theme solidThemes" data-color="solid_australiaRoom" style="background-image: url('../Images/skin/myroom/new_bg_image_adult_version.png'); background-position:center; background-size: contain;background-repeat: no-repeat;  top: 61px;" onclick="SelectColor(this);" >
                            <label style="top: 61px;display:none;">Australian Room</label>
                        </div>
                        <div id="basketball1" class="theme solidThemes" data-color="solid_basketball" style="background-image: url('../Images/skin/myroom/new_bg_image_adult_version.png'); background-position:center; background-size: contain;background-repeat: no-repeat;  top: 61px;" onclick="SelectColor(this);" >
                            <label style="top: 61px;display:none;">Basketball Room</label>
                        </div>
                        <div id="tennis1" class="theme solidThemes" data-color="solid_TennisRoom" style="background-image: url('../Images/skin/myroom/new_bg_image_adult_version.png'); background-position:center; background-size: contain;background-repeat: no-repeat;  top: 61px;" onclick="SelectColor(this);" >
                            <label style="top: 61px;display:none;">Tennis Room</label>
                        </div>
                        <div id="rugby1" class="theme solidThemes" data-color="solid_RugbyRoom" style="background-image: url('../Images/skin/myroom/new_bg_image_adult_version.png'); background-position:center; background-size: contain;background-repeat: no-repeat;  top: 61px;" onclick="SelectColor(this);" >
                        </div>
                        <div id="foorball1" class="theme solidThemes" data-color="solid_FootballRoom" style="background-image: url('../Images/skin/myroom/new_bg_image_adult_version.png'); background-position:center; background-size: contain;background-repeat: no-repeat;  top: 61px;" onclick="SelectColor(this);" >
                        </div>
                    </div>
                </div>

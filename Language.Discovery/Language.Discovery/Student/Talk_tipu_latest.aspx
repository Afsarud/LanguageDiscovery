            ...
            <div id="mtabs">
                <div class="smc_criteria_container" id="smc_criteria_container">
                    ...
                    <ul class="tabs_links_menu">
						...
						<li id="liTabWordForPhrase" class="wordTab" style="background: #3868D6 !important; color: #FFFFFF !important"><asp:HyperLink CssClass="send-msg-tabs5" ID="HyperLink4" href="#mtab5" runat="server" Text="Word" meta:resourcekey="linkTabWordResource1"/></li>

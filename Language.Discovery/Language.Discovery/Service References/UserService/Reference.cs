...
namespace Language.Discovery.UserService {
    ...
    public interface IUser {
        ...
        Language.Discovery.UserService.SearchUserAdminResponse SearchUserAdmin(Language.Discovery.UserService.SearchUserAdminRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IUser/SearchUserAdmin", ReplyAction="http://tempuri.org/IUser/SearchUserAdminResponse")]
        System.Threading.Tasks.Task<Language.Discovery.UserService.SearchUserAdminResponse> SearchUserAdminAsync(Language.Discovery.UserService.SearchUserAdminRequest request);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IUserChannel : Language.Discovery.UserService.IUser, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class UserClient : System.ServiceModel.ClientBase<Language.Discovery.UserService.IUser>, Language.Discovery.UserService.IUser {
        ...
        Language.Discovery.UserService.SearchUserAdminResponse Language.Discovery.UserService.IUser.SearchUserAdmin(Language.Discovery.UserService.SearchUserAdminRequest request) {
        ...
        public string SearchUserAdmin(Language.Discovery.Entity.SearchUserDTO tObject, out int virtualcount) {
            Language.Discovery.UserService.SearchUserAdminRequest inValue = new Language.Discovery.UserService.SearchUserAdminRequest();
            inValue.tObject = tObject;
            Language.Discovery.UserService.SearchUserAdminResponse retVal = ((Language.Discovery.UserService.IUser)(this)).SearchUserAdmin(inValue);
            virtualcount = retVal.virtualcount;
            return retVal.SearchUserAdminResult;
        }
        
        public System.Threading.Tasks.Task<Language.Discovery.UserService.SearchUserAdminResponse> SearchUserAdminAsync(Language.Discovery.UserService.SearchUserAdminRequest request) {

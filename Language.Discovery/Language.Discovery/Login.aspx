    ...
    <div class="content-home-main">
      ...
      <div class="bg-content container-fluid">
        <div class="row" style="background-color: white !important">
          ...
          <div class="d-none d-lg-block col-lg-6 col-md-12 content-left leftSide" style="padding: 0% 0% 0% 5%; margin: 10px 0px 0px 0px;">
          ...
          <div class="col-lg-6 col-md-12 content-right" style="align-items:center; margin-top: 150px">
            <div id="loginForm">
              <div class="loginform-shadow">
                          ...
                          <div class="login-form">
                            <div class="sign-in-htm">
                              ...
                              <div class="group">
                                ...
                                <p>Don't have account? <a href="https://www.palaygo.net.au/" target="_blank" style="color:blue; cursor: pointer">Register Now</a></p>
               ...
               <div style="display: flex; flex-direction:column; margin-top: 30px">
                ...
                <div class="">
                   <%-- <p>Patented/Patent Pending  Copyright 2018-2022 Language Discovery Ltd. All Rights Reserved.</p>--%>
                    <p style="text-align: center">© Copyright 2018-2024 Language Discovery Ltd. All Rights Reserved.</p>
                </div>

...
namespace Language.Discovery.Admin
{
    public partial class FileUploader : System.Web.UI.Page
    {
        ...
        private void GetPaths()
        {
            ...
            string path = System.Configuration.ConfigurationManager.AppSettings["SoundDirectory"];
            string[] directories = Directory.GetDirectories(path + @"Sound\", "*", SearchOption.AllDirectories);
        ...
        private string Upload()
        {
            ...
            string path = System.Configuration.ConfigurationManager.AppSettings["SoundDirectory"] + hdnDirectory.Value;

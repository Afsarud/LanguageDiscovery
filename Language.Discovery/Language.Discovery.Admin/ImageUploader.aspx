<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ImageUploader.aspx.cs" Inherits="Language.Discovery.Admin.ImageUploader" %>
    ...
    <table>
        ...
        <tr>
            <td>
                ...
                <asp:Label ID="lblDirectory" runat="server" Text="\images\" ClientIDMode="Static" style="font-size:large; font-weight:bold;color:red;"></asp:Label>
                <br />

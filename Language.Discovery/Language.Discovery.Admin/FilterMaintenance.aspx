<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.Master" AutoEventWireup="true" CodeBehind="FilterMaintenance.aspx.cs" Inherits="Language.Discovery.Admin.FilterMaintenance" EnableEventValidation="false" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
     <div style="width:100%;border:1px solid black;text-align:center;">
            <asp:Label ID="lblTitle" runat="server" Text="Filter Maintenance" meta:resourcekey="lblTitleResource1"></asp:Label>
    </div>
</asp:Content>
                    ...
                    <ContentTemplate>
                        <fieldset class="fieldset">
                            <legend>
                             ...
                             <table>
                                <tr>
                                    <td><asp:Label ID="lblSearchType" runat="server" meta:resourcekey="lblSearchTypeResource1">Filter</asp:Label></td>
                                    <td>
                                        <asp:TextBox ID="txtSearchFilter" runat="server" meta:resourcekey="txtSearchFilterResource1"></asp:TextBox>
                                    </td>
                            ...
                            <asp:GridView ID="grdResult" runat="server" DataKeyNames="FilterID"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="FilterName" HeaderText="Filter" meta:resourcekey="BoundFieldFilterNameResource1" >
                ...
                <asp:UpdatePanel ID="upDetail" runat="server"  UpdateMode="Conditional">
                    <ContentTemplate>
                        <fieldset>
                            ...
                            <table>
                                <tr>
                                    <td><asp:Label ID="lblFilter" runat="server" meta:resourcekey="lblFilterResource1">Filter</asp:Label></td>
                                     <td><asp:TextBox ID="txtFilter" runat="server" Width="560px" meta:resourcekey="txtFilterResource1"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Filter is required" ControlToValidate="txtFilter" ValidationGroup="v" ForeColor="Red" meta:resourcekey="RequiredFieldValidator2Resource1">*</asp:RequiredFieldValidator>
                                     </td>   
                                </tr>
                            </table>

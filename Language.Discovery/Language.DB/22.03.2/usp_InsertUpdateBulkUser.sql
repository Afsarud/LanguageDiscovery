...
begin
   ...
   declare @EnabledFreeMessage bit
   declare @SoundAndMail bit
   Declare @OrderByLearning bit
   Declare @AllowTalk bit
   ...
   @AfterSchool = AfterSchool, @EnabledFreeMessage = EnabledFreeMessage, 
   @SoundAndMail = SoundAndMail, @OrderByLearning = OrderByLearningLanguageFlag,
   @AllowTalk = AllowTalk

...
GO
/****** Object:  StoredProcedure [dbo].[usp_SaveMessage]    Script Date: 5/13/2020 6:24:33 PM ******/
SET ANSI_NULLS ON
GO
...
--</ArrayOfUserMessageContract>
	...
	BEGIN
		...
		INNER JOIN SchoolInfo S on u.SchoolID = s.SchoolID
		INNER JOIN SchoolType ST on s.SchoolTypeID = st.SchoolTypeID
		WHERE IsActive = 1 AND IsOnline = 1 and u.IsDemo = @IsDemo and UserTypeID = 3

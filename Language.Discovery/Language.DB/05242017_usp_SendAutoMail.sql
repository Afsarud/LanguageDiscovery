...
BEGIN
	...
	select top 1 @FirstDate = CreateDate from UserMessage where RecepientID = @UserID and IsActive = 1 order by CreateDate desc
	...
	begin
			...
			where datediff(dd,UM.CreateDate, GETDATE()) <= 60

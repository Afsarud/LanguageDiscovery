...
begin
	...
	INSERT INTO WordHeader ( CreateDate, CreatedByID, ImageFile, PhraseCategoryID, KeyWord,WordType, UserCreatedWord )
	values ( GETDATE(), @UserID, @ImageFile, @PhraseCategoryID, @Keyword, @WordType, @UserCreatedWord)

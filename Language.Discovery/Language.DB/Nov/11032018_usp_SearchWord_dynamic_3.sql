...
begin	
	...
	@SchoolPalette bit, @FirstQueryCount int, @TopCategoryHeaderID int, @IsTalk bit, @WordType nvarchar(50), @VirtualCount int output'

		
	  execute sp_executesql @MainSQL,	@ParamDefinition,@RowsPerPage, @PageNumber, @Word,@Keyword, 
	@CategoryID,@SchoolID, @GroupID, @SchoolPalette, @FirstQueryCount, @TopCategoryHeaderID,@IsTalk, @WordType, @VirtualCount = @VirtualCount output
